...
function loginAjax() {
    ...
    postData('http://104.46.123.34:3000/api/v1/Auth/CreateAccount', { username: usernameText, password: passwordText, email: usernameText })
        .then((data) => {
...
//Direct user to registration_success.html
function confirmRegisterSuccess() {
